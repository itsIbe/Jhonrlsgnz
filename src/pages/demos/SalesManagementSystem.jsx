...
export default function SalesManagementSystem({ onClose, project }) {
    useEffect(() => {
    ...
    return (
        <div className="demo-modal" role="dialog" aria-modal="true" aria-label="Sales Management demo">
            ...
            <div className="demo-shell">
                ...
                <div className="mos-system">
                    <div className="blank-demo-content">
                        ...
                        <p>This white panel is reserved for the Sales Management System demo.</p>
                    </div>
                </div>
            </div>
        </div>
