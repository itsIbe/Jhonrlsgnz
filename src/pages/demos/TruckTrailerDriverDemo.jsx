...
export default function TruckTrailerDriverDemo({ onClose, project }) {
    useEffect(() => {
    ...
    return (
        <div className="demo-modal" role="dialog" aria-modal="true" aria-label="Truck Trailer Driver demo">
            ...
            <div className="demo-shell">
                <header className="demo-topbar">
                    <div className="demo-topbar-left">
                        ...
                        <div>
                            <p className="demo-kicker">Great Sierra Development Corporation Project</p>
                            <h2>Truck, Trailer, and Driver Management System</h2>
                        </div>
                    </div>
                ...
                <div className="mos-system">
                    <div className="blank-demo-content">
                        ...
                        <p>This white panel is reserved for the Truck, Trailer, and Driver Management System demo.</p>
                    </div>
                </div>
            </div>
        </div>
